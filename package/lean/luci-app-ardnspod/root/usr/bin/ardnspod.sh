...
case $(uname) in
  'Linux')
    ...
    arIpAddress() {
        local extip
        extip=$(ip -o -4 addr list | grep -Ev '\s(docker|lo)' | awk '{print $4}' | cut -d/ -f1 | grep -Ev '(^127\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$)|(^10\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$)|(^172\.1[6-9]{1}[0-9]{0,1}\.[0-9]{1,3}\.[0-9]{1,3}$)|(^172\.2[0-9]{1}[0-9]{0,1}\.[0-9]{1,3}\.[0-9]{1,3}$)|(^172\.3[0-1]{1}[0-9]{0,1}\.[0-9]{1,3}\.[0-9]{1,3}$)|(^192\.168\.[0-9]{1,3}\.[0-9]{1,3}$)|(^100\.6[4-9]{1}\.[0-9]{1,3}\.[0-9]{1,3}$)|(^100\.[7-9]{1}[0-9]{1}\.[0-9]{1,3}\.[0-9]{1,3}$)|(^100\.1[0-1]{1}[0-9]{1}\.[0-9]{1,3}\.[0-9]{1,3}$)|(^100\.12[0-7]{1}\.[0-9]{1,3}\.[0-9]{1,3}$)')
        if [ "x${extip}" = "x" ]; then
